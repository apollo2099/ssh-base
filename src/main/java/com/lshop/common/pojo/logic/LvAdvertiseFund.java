...
/**
 * LvAdvertiseFund entity. @author MyEclipse Persistence Tools
 */

public class LvAdvertiseFund extends com.gv.core.datastructure.impl.BasePo
	...
	/** default constructor */
	public LvAdvertiseFund() {
	}

	/** full constructor */
	public LvAdvertiseFund(Integer uid, Integer totalnum, Double totalfund,
			Double enablefund, String couponCode, String storeId, String code,
