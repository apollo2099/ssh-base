...
/**
 * LvUserPromoters entity. @author MyEclipse Persistence Tools
 */

public class LvUserPromoters extends com.gv.core.datastructure.impl.BasePo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1084755731159987137L;
	private Integer id;
	...
	/** default constructor */
    public LvUserPromoters() {
    }

	/** minimal constructor */
    public LvUserPromoters(String realName, String email, Short approvalStatus, Short settlementStatus, Double settlementedAmount, Integer settlementedNum, Double settlementAmount, Integer settlementNum, Double nonSettlementAmount, Integer nonSettlementNum, String userRating, String storeId) {
    ...
    /** full constructor */
    public LvUserPromoters(String realName, String email, String tel, Short accountTypes, String accountNumber, Integer contryId, String contryName, Integer provinceId, String provincename, Integer cityId, String cityName, String adress, Short approvalStatus, String description, Short settlementStatus, Double settlementedAmount, Integer settlementedNum, Double settlementAmount, Integer settlementNum, Double nonSettlementAmount, Integer nonSettlementNum, String userRating, Integer uid, Integer userType, Double specialAmount, String storeId, String code, Date createTime, Date modifyTime, Integer modifyUserId, String modifyUserName, String atrr, String atrr1, String atrr2, String atrr3) {
        this.realName = realName;
        this.email = email;
        this.tel = tel;
    ...
    public Integer getPnumEd() {
		return pnumEd;
	}

	public void setPnumEd(Integer pnumEd) {
		this.pnumEd = pnumEd;
	}
