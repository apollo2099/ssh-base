...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params,AlipayConfig alipayConfig) {
        ...
        String mysign = getMysign(params,alipayConfig);
        String responseTxt = "true";
        if(params.get("notify_id") != null) {responseTxt = verifyResponse(params.get("notify_id"),alipayConfig);}
        String sign = "";
     ...
     * @return 生成的签名结果
     */
    private static String getMysign(Map<String, String> Params,AlipayConfig alipayConfig) {
        Map<String, String> sParaNew = AlipayCore.paraFilter(Params);//过滤空值、sign与sign_type参数
        String mysign = AlipayCore.buildMysign(sParaNew,alipayConfig);//获得签名结果
        return mysign;
    }
